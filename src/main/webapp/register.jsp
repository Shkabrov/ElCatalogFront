        ...
        <form method="get" action="Direct">
            <div id="navBar1">
                ...
                text-decoration: none;">
                    Авторизация</button>
                <button type="submit" id="outputLogin" name="method" value="login" class="navig"
                        style="
                margin-top: 0px;
                padding: 10px;
                color: #000000;
...
<section class="Registration" id="register">
    <article class="register">
        <div class="registration">
            ...
            <button onclick="register(); window.location.href =
                    'http://localhost:8080/ElCatalogFront_war_exploded/index.jsp'"
                    class="registerPeople">Зарегистрироваться</button>
        </div>
    </article>
</section>
